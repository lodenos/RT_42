...
/*   Updated: 2016/10/01 16:06:11 by glodenos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void                    get_spot(t_spt *spt, char **line)
{
    ...
    spt->light = get_value_double(line[3]);
    spt->ambient = get_value_double(line[4]);
    spt->specular = get_value_double(line[5]);
    spt->diffuse = get_value_double(line[6]);
    spt->end = 1;
}
