...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/19 23:22:11 by glodenos          #+#    #+#             */
/*   Updated: 2016/09/20 12:15:01 by glodenos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lib_RT.h"

static void err_cl_ex_d(cl_int err)
{
    if (err == -52)
...
static void err_cl_ex_c(cl_int err)
{
    if (err == -41)
...
static void err_cl_ex_b(cl_int err)
{
    if (err == -30)
...
static void err_cl_ex_a(cl_int err)
{
    if (err == -11)
